...
class Flowerinpot(Product):
    ...
    pot_color = models.CharField(max_length=255, verbose_name='Цвет горшка')
    grooming_instructions = models.CharField(max_length=255, verbose_name='Инструкция по уходу')
